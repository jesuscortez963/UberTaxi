...
import com.equipo.ubertaxi.activities.driver.HistoryBookingDetailDriverActivity;
...
public class HistoryBookingDriverAdapter extends FirebaseRecyclerAdapter<HistoryBooking, HistoryBookingDriverAdapter.ViewHolder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull HistoryBookingDriverAdapter.ViewHolder holder, int position, @NonNull HistoryBooking historyBooking) {
